...
from .query_support import QuerySupportDetectorSVFA
from .utils import TestMixins

@DETECTORS.register_module()
class SVFA(QuerySupportDetectorSVFA, TestMixins):
    """Implementation of `SVFA.  <https://arxiv.org/abs/tbd>`_.
    Args:
